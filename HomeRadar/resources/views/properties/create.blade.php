...
<div class="intro-y box">
    ...
    <div id="input" class="p-5">
        <div class="preview">
            <form method="POST" action="{{ route('properties.store') }}" enctype="multipart/form-data" class="dropzone" id="property-dropzone">
                @csrf
                <div>
                ...
                <div class="mt-3">
                    ...
                    <select id="availability" name="availability" class="form-control">
                        <option value="1">Available</option> <!-- 1 يمثل true -->
                        <option value="0">Not Available</option> <!-- 0 يمثل false -->
                    </select>
                </div>
                <div class="mt-3">
