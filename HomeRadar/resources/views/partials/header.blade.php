<header class="main-header">
    <!--  logo  -->
    <div class="logo-holder"><a href="{{ route('user.home') }}"><img src="images/logo.png" alt=""></a></div>
    <!-- logo end  -->
    <!-- nav-button-wrap--> 
    ...
    <div class="add-list_wrap">
        <a href="{{ url('dashboard-add-listing') }}" class="color-bg"><i class="fal fa-plus"></i> <span>Add Listing</span></a>
    </div>
    <!--  add new  btn end -->
    <!--  header-opt_btn -->
...
@endif
    ...
    <div class="main-menu">
        <nav>
            <ul class="no-list-style">
                <li>
                    <a href="{{ route('user.home') }}" class="act-link">Home</a>
                </li>
                <li><a href="contacts.html">Contacts</a></li>
                <li>
                    <a href="{{ url('dashboard-add-listing') }}">Listings </a>
                </li>
    ...
    <nav class="menusb sliding-menu" style="height: 170px;"><div class="sliding-menu-wrapper" style="width: 1434.67px;"><ul class="no-list-style menu-panel-root" id="menu-panel-7clfw" style="width: 239.111px;">
                <li>
                    <a href="#menu-panel-tefww" class="act-link nav">Home <i class="fa fa-caret-down"></i></a>
                    <!--second level -->   
                    
                    <!--second level end-->
                </li>
                <li>
                    <a href="#menu-panel-mpmjn" class="nav">Listings <i class="fa fa-caret-down"></i></a>
                    <!--second level -->
                    
                    <!--second level end-->
                </li>
                <li>
                    <a href="#menu-panel-ig34w" class="nav">Agents<i class="fa fa-caret-down"></i></a>
                    <!--second level -->   
                ...
                <li>
                    <a href="#menu-panel-e63k2" class="nav">Pages <i class="fa fa-caret-down"></i></a>
                    <!--second level -->   
                    
                    <!--second level end-->                                
                </li>
            </ul><ul id="menu-panel-tefww" class="menu-panel" style="width: 239.111px;"><a class="back" href="#menu-panel-back"></a>
                        <li><a href="index.html">Parallax Image</a></li>
                        <li><a href="index2.html">Slider</a></li>
                        <li><a href="index3.html">Video</a></li>
                        <li><a href="index4.html">Slideshow</a></li>
                        <li><a href="dark/index.html" target="_blank">Dark Demo</a></li>
                    </ul><ul id="menu-panel-mpmjn" class="menu-panel" style="width: 239.111px;"><a class="back" href="#menu-panel-back"></a>
                        ...
                        <li>
                            <a href="#menu-panel-4wwq1" class="nav">Single <i class="fa fa-caret-down"></i></a>
                            <!--third  level  -->
                            
                            <!--third  level end-->
                        </li>
                    </ul><ul id="menu-panel-4wwq1" class="menu-panel" style="width: 239.111px;"><a class="back" href="#menu-panel-back"></a>
                                <li><a href="listing-single.html">Style 1</a></li>
                                <li><a href="listing-single2.html">Style 2</a></li>
                                <li><a href="listing-single3.html">Style 3</a></li>
                            </ul><ul id="menu-panel-ig34w" class="menu-panel" style="width: 239.111px;"><a class="back" href="#menu-panel-back"></a>
                    ...
                    </ul><ul id="menu-panel-e63k2" class="menu-panel" style="width: 239.111px;"><a class="back" href="#menu-panel-back"></a>
                        <li><a href="about.html">About</a></li>
                        <li><a href="contacts.html">Contacts</a></li>
                        <li><a href="help.html">Help FAQ</a></li>
                        <li><a href="pricing.html">Pricing </a></li>
                        ...
                        <li><a href="coming-soon.html">Coming Soon</a></li>
                        <li><a href="404.html">404</a></li>
                    </ul></div></nav><div class="header-opt-modal-container hopmc_init header-opt-modal-container_mob">
        ...
        </div><a href="dashboard-add-listing.html" class="color-bg add-list_mob"><i class="fal fa-plus"></i> <span>Add Listing</span></a></div>
    <!-- navigation  end -->
        ...
        <div class="tabs-container">
            <div class="tab">
                ...
                <div id="tab-wish" class="tab-content first-tab">
                    ...
                    <div class="header-modal-container scrollbar-inner fl-wrap" data-simplebar="init"><div class="simplebar-wrapper" style="margin: -10px -17px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content" style="padding: 10px 17px; height: auto; overflow: hidden;">
                        <!--widget-posts-->
    ...
    <script>
        document.querySelector('.show-reg-form logout-form').addEventListener('click', function(e) {
            e.preventDefault();
            document.getElementById('show-reg-form logout-form').submit();
        });
    </script>
</header>