                ...
                <div class="compare-slider fl-wrap">
                    ...
                    <div class="slick-slide-item">
                        <div class="compare-column">
                            <div class="compare-link fl-wrap">
                                <div class="compare-link-meia fl-wrap">
                                    <div class="bg par-elem "  data-bg="images/all/2.jpg"></div>
                                    <div class="remove-compare color-bg"><i class="fal fa-times"></i></div>
                                </div>
                    ...
                    <div class="slick-slide-item">
                        <div class="compare-column">
                            <div class="compare-link fl-wrap">
                                <div class="compare-link-meia fl-wrap">
                                    <div class="bg par-elem "  data-bg="images/all/8.jpg"></div>
                                    <div class="remove-compare color-bg"><i class="fal fa-times"></i></div>
                                </div>
                    ...
                    <div class="slick-slide-item">
                        <div class="compare-column">
                            <div class="compare-link fl-wrap">
                                <div class="compare-link-meia fl-wrap">
                                    <div class="bg par-elem "  data-bg="images/all/9.jpg"></div>
                                    <div class="remove-compare color-bg"><i class="fal fa-times"></i></div>
                                </div>
