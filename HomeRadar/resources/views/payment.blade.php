    ...
    <div class="card-container">
        ...
        <div class="front">
            <div class="image">
                ...
                <img src="{{ asset('storage/properties/9VlWkokvQFhzhfuyeicfG0cZx37zLcSYxLykqg14.png') }}" alt="Visa">
                <img src="{{ asset('storage/properties/9QN6JuWYFgGdDSbr0mwcE9dRjniFH07cgy6SjBoW.png') }}" alt="Visa">
