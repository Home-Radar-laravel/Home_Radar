...
Route::post('/bookings', [BookingController::class, 'store'])->name('user_bookings.store');

// Resource route for properties
Route::get('/bookings', [BookingController::class, 'index'])->name('user_bookings.index');
...
// تخزين عقار جديد
Route::post('/properties', [admin_PropertyController::class, 'store'])->name('properties.store');
